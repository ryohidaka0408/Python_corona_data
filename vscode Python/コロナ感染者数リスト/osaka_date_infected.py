...
with open("C:/HIdaka ryo/Python/コロナ感染者数リスト/大阪府日別コロナ感染者数リスト.csv","w",encoding="UTF-8")as d:
    for result in zip(date_list,all_list):
        d.write(f"大阪府の日別コロナ感染者数:{result[0]}は、{result[1]:4d}人です。\n")